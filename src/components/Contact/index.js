...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Validate fields
    if (!feedback.email || !feedback.name || !feedback.subject || !feedback.message) {
      setError(true);
      return;
    }

    const feedbackRef = ref(database, 'feedback'); // Use the database object from firebase.js
    ...
    <Container id="contact">
      <Wrapper>
        ...
        <ContactForm ref={form} onSubmit={handleSubmit}>
          ...
          <ContactInput placeholder="Your Email" name="from_email" aria-label="Email" required />
